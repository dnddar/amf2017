...
if( mysqli_num_rows( $result ) == 0 ){
	...
	if( ( $data['image'] != '') && file_exists( '../pic/csr/'.$data['image'] ) )
		$pic = "<img src='../pic/csr/".$data['image']."'>";
}
...
$(function(){
	...
	$('#pic_upload').uploader(
		'pic_upload_csr.php',
		function(filename){
			$('#pic').html('<img src="../pic/csr/'+filename+'">');
		},
		function(error){
			alert('Error! '+error);
		}
  ...
  <div class="cont_r">
    <table cellpadding="2" cellspacing="2" border="0"class="listtable">
      ...
      <tr>
       ...
       <tr><th><div class="title">出處</div></th><td><input type="text" id="rights" style="width:755px;" value="<?=$data['rights']?>"></td>
